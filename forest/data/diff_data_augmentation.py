...
class RandomTransform(torch.nn.Module):
    ...
    def __init__(self, source_size, target_size, shift=8, fliplr=True, flipud=False, mode='bilinear', align=True, setup={'device': 'cpu'}):
        ...
        self.grid = self.grid.to(**setup)
        self.delta = self.delta.to(**setup)
