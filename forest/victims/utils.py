...
def save_stats(stats, train_loss, train_acc, valid_acc, valid_loss, targets):
    """Print info into console and into the stats object."""
    stats['train_losses'].append(train_loss)
    stats['train_accs'].append(train_acc)

    if valid_acc is not None:
        target_acc, target_loss, target_clean_acc, target_clean_loss = targets
...
def print_and_save_stats(epoch, stats, current_lr, train_loss, train_acc, valid_acc, valid_loss, targets):
    """Print info into console and into the stats object."""

    save_stats(stats, train_loss, train_acc, valid_acc, valid_loss, targets)
    if valid_acc is not None:
